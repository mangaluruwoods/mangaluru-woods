...
const WhatsAppFloater: React.FC<WhatsAppFloaterProps> = ({
  ...
  return (
    ...
    >
      <div className="bg-[#25D366] p-3.5 rounded-full shadow-lg flex items-center justify-center">
      ...
      <div className="absolute -top-10 right-0 bg-white text-gray-800 px-3 py-1 rounded-lg shadow-md opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap">
        Chat with us
      </div>
    </div>
  )
